...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { city: @branch.city, name: @branch.name, street: @branch.street, streetNr: @branch.streetNr, zipCode: @branch.zipCode }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { city: @branch.city, name: @branch.name, street: @branch.street, streetNr: @branch.streetNr, zipCode: @branch.zipCode }
    assert_redirected_to branch_path(assigns(:branch))
  end
